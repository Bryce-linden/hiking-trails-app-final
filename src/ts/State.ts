...
export default class State extends Accessor {
  ...
  setSelectedTrail(id: number) {
    console.log("this is this.trails, it's an array: ", this.trails)
    this.selectedTrailId = id;
    console.log("this is the selectedtrailid:" + this.selectedTrailId);
    this.selectedTrail = this.trails.filter((trail: Trail) => {
      console.log("this is id:" ,id)
      console.log("this is trail.id:" ,trail.id)
      console.log("this is selectedTrail: ",this.selectedTrail)
      return (trail.id === id);
  ...
  @property()
  visiblePanel: "selectionPanel" | "detailPanel" | "basemapPanel" | "geologypanel";
