...
import GeologyPanel from "./Geologytab";
...
export default class MenuPanel {
  ...
  constructor(state: State) {
    ...
    const geologypanel = new GeologyPanel(state);
    ...
    on(dom.byId("help"), "click", function() {
      dom.byId("helpPanel").style.display = "inline";
    });
    on(dom.byId("closehelp"), "click", function() {
      dom.byId("helpPanel").style.display = "none";
    });
